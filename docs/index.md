...
| UML use case diagram | Actor and use case modelling with include/extend relationships | [View diagram](https://github.com/hardikk-777/UCS503P-202627-Blynk/blob/master/docs/diagrams/Use_Case_Diagram.pdf) |
| Data flow diagrams | Context, Level 1, and Level 2 process decomposition | [View diagrams](https://github.com/hardikk-777/UCS503P-202627-Blynk/blob/master/docs/diagrams/DFD_Levels_0_1_2.pdf) |
| Entity-relationship diagram | Local data model for metrics, break events, and history | [View diagram](https://github.com/hardikk-777/UCS503P-202627-Blynk/blob/master/docs/diagrams/ER_Diagram.pdf) |
| Activity / swimlane diagram | User and System workflow through detection, break, and verification | [View diagram](https://github.com/hardikk-777/UCS503P-202627-Blynk/blob/master/docs/diagrams/ActivityDiag.drawio.png) |
| Gantt chart | 8 week development schedule | [View chart](https://github.com/hardikk-777/UCS503P-202627-Blynk/blob/master/docs/diagrams/Blynk_gant_chart.pdf) |
